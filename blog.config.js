...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '995f438473bb40ffb006f9bc0883302f',
  PSEUDO_STATIC: process.env.NEXT_PUBLIC_PSEUDO_STATIC || true, // 伪静态路径，开启后所有文章URL都以 .html 结尾。
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 0, // 更新内容缓存间隔 单位(秒)；即每个页面有5秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://mackie-muder.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'mackie', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'jason.li@student.tgc.vic.edu.au', // 邮箱地址 例如mail@tangly1024.com
  ...
  PREVIEW_TAG_COUNT: 3, // 首页最多展示的标签数量，0为不限制
